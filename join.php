...
<body class="bg">
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <a class="navbar-brand heading" href="home.php">Travello</a>
...
function tablerows(){
  ...
  for(var i=1;i<j;i++)
  {
    ...
    aadhar.innerHTML = "<input type='text' maxlength='12' name='aadharno"+i+"' pattern='([0-9]{12})'>";
  ...
  function addRow(){
   var row1 = document.getElementById('passengertable').insertRow();
    ...
    aadhar1.innerHTML = "<input type='text' maxlength='12' name='aadharno"+(passengers)+"' pattern='([0-9]{12})'>";
